...
export const agreement = {
  ...
  scope: [
    ...
    "When both parties agree in writing to turn on online card payment, checkout will charge through the shop's Square account at Square's published processing rate. Each online card order will carry a $0.99 service fee paid by the customer at checkout, shown as its own line item, retained by Glazed Web as the ordering platform fee. It is never charged to the Client.",
  ],
